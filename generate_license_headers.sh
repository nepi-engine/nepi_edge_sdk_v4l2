...
TEMPLATE_FILE=$1
TARGET_DIR='.'
EXCLUSIONS='*generate_license_headers.sh* *num_factory* *package.xml* *__init__.py* *setup.py*'
OWNER='Numurus, LLC <https://www.numurus.com>'
PROJECT='nepi_edge_sdk_v4l2'
PROJECT_URL='https://github.com/numurus-nepi/nepi_edge_sdk_v4l2'
